...
// AI 설계 — 로봇
export const IllustRobot = ({ size = 72 }: P) => (
  <svg width={size} height={size} viewBox="0 0 72 72" fill="none">
    <path d="M36 12v6" stroke="var(--teal-600)" strokeWidth="3" strokeLinecap="round" />
    <circle cx="36" cy="10" r="3" fill="var(--teal-600)" />
    <rect x="18" y="20" width="36" height="30" rx="9" fill="var(--teal-100)" stroke="var(--teal-600)" strokeWidth="3" />
    <circle cx="29" cy="34" r="3.5" fill="var(--teal-700)" />
    <circle cx="43" cy="34" r="3.5" fill="var(--teal-700)" />
    <path d="M29 42h14" stroke="var(--teal-600)" strokeWidth="3" strokeLinecap="round" />
    <path d="M14 30v10M58 30v10" stroke="var(--teal-500)" strokeWidth="3" strokeLinecap="round" />
  </svg>
);
